        ...
        <div className="w-full max-w-[440px] flex flex-col">
          ...
          <div className="bg-white lg:shadow-[0_8px_40px_-12px_rgba(15,23,42,0.08)] rounded-[16px] p-8 lg:p-10 border border-outline-variant/20 lg:border-none">
            ...
            <div className="space-y-3 mb-8">
              <button className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border border-outline-variant rounded-xl font-label-md text-label-md text-on-surface hover:bg-surface-container-low transition-colors duration-200">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-12 pr-4 py-3 h-[44px] bg-surface-container-lowest border border-outline-variant rounded-xl focus:ring-4 focus:ring-primary-container/10 focus:border-primary-container outline-none transition-all duration-200"
                    id="email"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-12 pr-12 py-3 h-[44px] bg-surface-container-lowest border border-outline-variant rounded-xl focus:ring-4 focus:ring-primary-container/10 focus:border-primary-container outline-none transition-all duration-200"
                    id="password"
                    placeholder="••••••••"
                  ...
                  />
                  <button
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors duration-200"
          ...
          {/* Legal Footer */}
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4 text-outline-variant/60 font-label-sm text-[11px] uppercase tracking-wider">
            <span>© 2024 SWASTHA HEALTHCARE</span>
