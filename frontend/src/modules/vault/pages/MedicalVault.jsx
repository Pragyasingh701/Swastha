    ...
    <header className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-6">
      ...
      <div className="flex items-center justify-between sm:justify-start gap-3 shrink-0">
        ...
        <img
          ...
          alt="User"
          className="w-10 h-10 rounded-full object-cover transition-transform duration-200 hover:scale-110 shrink-0"
        />
      </div>
    </header>
  );
...
function DocCard({ doc }) {
  ...
  return (
    <div className="border border-slate-100 rounded-xl p-4">
      ...
      <button
        className={`w-full text-xs font-semibold px-3.5 py-2 rounded-lg transition-all duration-200 ${
