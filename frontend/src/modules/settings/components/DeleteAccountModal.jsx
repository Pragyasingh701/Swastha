    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-5">
          <div className="p-3.5 rounded-xl flex items-start gap-2.5 text-xs font-semibold bg-rose-50 text-rose-800 border border-rose-200 ">
          ...
          {error && (
            <div className="p-3.5 rounded-xl text-xs font-semibold bg-rose-50 text-rose-800 border border-rose-200 ">
              {error}
            </div>
          )}
          ...
          <div>
            ...
            <input
              ...
              placeholder="DELETE"
              className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-900 focus:ring-2 focus:ring-rose-500 focus:outline-none transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 px-5 py-2.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
