...
export default function LandingPage() {
  ...
  return (
    <div className="bg-background dark:bg-slate-950 text-on-surface dark:text-slate-100 font-body-md selection:bg-primary/20">
      {/* TopNavBar */}
      <header className="bg-surface/80 dark:bg-surface-dim/80 backdrop-blur-lg fixed top-0 w-full z-50 border-b border-outline-variant/30 dark:border-slate-700 shadow-sm">
        <div className="flex justify-between items-center w-full px-6 py-3 max-w-screen-2xl mx-auto">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a className="text-on-surface-variant dark:text-slate-400 hover:text-primary transition-colors font-body-md" href="#features">Features</a>
            <a className="text-on-surface-variant dark:text-slate-400 hover:text-primary transition-colors font-body-md" href="#abha">ABHA Sync</a>
            <a className="text-on-surface-variant dark:text-slate-400 hover:text-primary transition-colors font-body-md" href="#vault">Vault</a>
            <a className="text-on-surface-variant dark:text-slate-400 hover:text-primary transition-colors font-body-md" href="#timeline">Timeline</a>
          </nav>
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate("/login")}
              className="hidden sm:block text-on-surface-variant dark:text-slate-400 font-label-md hover:text-primary transition-colors"
            >
              Login
            </button>
            <button
      ...
      <main className="pt-20">
        ...
        <section className="relative overflow-hidden px-6 lg:px-2xl py-20 lg:py-3xl max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="z-10 text-center lg:text-left">
              ...
              <p className="text-body-lg text-on-surface-variant dark:text-slate-400 mb-10 max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <button className="bg-surface-container dark:bg-slate-700 border border-outline-variant dark:border-slate-700 text-on-surface dark:text-slate-100 px-8 py-4 rounded-xl font-label-md font-bold text-lg hover:bg-surface-container-high transition-all flex items-center justify-center gap-2">
        ...
        {/* Trust Section */}
        <section className="bg-surface-container-low dark:bg-slate-800 py-12 border-y border-outline-variant/30 dark:border-slate-700">
        ...
        <section className="py-20 lg:py-32 px-6 overflow-hidden" id="vault">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-on-surface-variant dark:text-slate-400 max-w-2xl mx-auto">From chaotic digital clutter to a structured life-saving timeline.</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
              {/* Problem Card */}
              <div className="p-8 rounded-3xl bg-surface-container-highest/50 dark:bg-slate-800/60 border border-outline-variant/50 dark:border-slate-700 relative group">
                ...
                <p className="text-on-surface-variant dark:text-slate-400 mb-8">Reports scattered across WhatsApp threads, email attachments, and lost PDFs. Finding a prescription from 6 months ago is impossible during emergencies.</p>
                <div className="space-y-4 opacity-50 grayscale group-hover:grayscale-0 transition-all">
                  <div className="flex items-center gap-4 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-outline-variant/20 dark:border-slate-700">
                    <span className="material-symbols-outlined text-[#25D366]">chat</span>
                    <div className="flex-1 h-3 bg-surface-container dark:bg-slate-700 rounded-full"></div>
              ...
              {/* Solution Card */}
              <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 border border-primary/20 shadow-2xl shadow-primary/5 relative overflow-hidden group">
                ...
                <p className="text-on-surface-variant dark:text-slate-400 mb-8">Clinical-grade OCR extracts every lab value and medicine name, creating a searchable, intelligent health journey for your whole family.</p>
                <div className="space-y-4">
                  <div className="ai-insight-glow p-4 rounded-xl flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-on-surface-variant dark:text-slate-400">Improving trend over 12 months</p>
                    </div>
                    <span className="text-primary font-bold">5.8%</span>
                  </div>
                  <div className="p-4 bg-surface-container dark:bg-slate-700 rounded-xl flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-on-surface-variant dark:text-slate-400">Metformin 500mg • Daily</p>
                    </div>
        ...
        {/* How It Works */}
        <section className="bg-surface dark:bg-slate-900 py-20 lg:py-32 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
              <div className="max-w-xl">
                <h2 className="font-headline-lg text-headline-lg mb-4">How It Works</h2>
                <p className="text-on-surface-variant dark:text-slate-400">From messy documents to medical intelligence in four simple steps.</p>
              </div>
              <div className="flex gap-2">
                <div className="w-12 h-1 bg-primary rounded-full"></div>
                <div className="w-12 h-1 bg-outline-variant dark:bg-slate-700 rounded-full"></div>
                <div className="w-12 h-1 bg-outline-variant dark:bg-slate-700 rounded-full"></div>
              </div>
            </div>
            <div className="grid md:grid-cols-4 gap-8 relative">
              ...
              <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
                <div className="w-20 h-20 bg-white dark:bg-slate-800 shadow-lg rounded-2xl flex items-center justify-center mb-6 border border-outline-variant/30 dark:border-slate-700 group hover:border-primary transition-colors">
                ...
                <p className="text-sm text-on-surface-variant dark:text-slate-400">Share files from WhatsApp, email, or snap a photo of a physical report.</p>
              </div>
              {/* Step 2 */}
              <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
                <div className="w-20 h-20 bg-white dark:bg-slate-800 shadow-lg rounded-2xl flex items-center justify-center mb-6 border border-outline-variant/30 dark:border-slate-700 group hover:border-primary transition-colors">
                ...
                <p className="text-sm text-on-surface-variant dark:text-slate-400">Our clinical AI extracts lab results, dosages, and diagnostic insights.</p>
              </div>
              {/* Step 3 */}
              <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
                <div className="w-20 h-20 bg-white dark:bg-slate-800 shadow-lg rounded-2xl flex items-center justify-center mb-6 border border-outline-variant/30 dark:border-slate-700 group hover:border-primary transition-colors">
                ...
                <p className="text-sm text-on-surface-variant dark:text-slate-400">Records are categorized by family member, doctor, and health category.</p>
              </div>
              {/* Step 4 */}
              <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left">
                <div className="w-20 h-20 bg-white dark:bg-slate-800 shadow-lg rounded-2xl flex items-center justify-center mb-6 border border-outline-variant/30 dark:border-slate-700 group hover:border-primary transition-colors">
                ...
                <p className="text-sm text-on-surface-variant dark:text-slate-400">Access a unified health timeline with trends, alerts, and instant search.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-32 px-6 bg-surface-container-lowest dark:bg-slate-900" id="features">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-headline-lg text-headline-lg mb-4">Smarter Healthcare for Modern Families</h2>
              <p className="text-on-surface-variant dark:text-slate-400">Advanced features designed for reliability and speed.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {/* WhatsApp Feature */}
              <div className="md:col-span-2 p-8 rounded-3xl bg-white dark:bg-slate-800 border border-outline-variant/50 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-on-surface-variant dark:text-slate-400 max-w-md">Just forward any report to our verified number. Our AI picks it up instantly and files it in the right vault automatically.</p>
                </div>
              </div>
              {/* AI OCR Feature */}
              ...
              {/* Drug Interactions */}
              <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 border border-outline-variant/50 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-on-surface-variant dark:text-slate-400">Automatic drug-to-drug interaction checks when you upload new prescriptions.</p>
              </div>
              {/* Lab Trends */}
              <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 border border-outline-variant/50 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-on-surface-variant dark:text-slate-400">Visualize how your health metrics change over time with intuitive, auto-generated charts.</p>
              </div>
              {/* Smart Search */}
              <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 border border-outline-variant/50 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-on-surface-variant dark:text-slate-400">Search for &quot;Diabetes reports 2022&quot; or &quot;Dr. Sharma prescriptions&quot; and get results in milliseconds.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="bg-surface-container-low dark:bg-slate-800 border-t border-outline-variant/50 dark:border-slate-700 pt-20 pb-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-on-surface-variant dark:text-slate-400 text-sm mb-6">Clinical intelligence for families. Secure, organized, and accessible health records powered by AI.</p>
              <div className="flex gap-4">
                <a className="w-10 h-10 rounded-full bg-surface-container dark:bg-slate-700 flex items-center justify-center hover:bg-primary/10 hover:text-primary transition-all" href="#">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-on-surface-variant dark:text-slate-400">
          ...
          <div className="pt-8 border-t border-outline-variant/30 dark:border-slate-700 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-body-sm text-on-surface-variant dark:text-slate-400">© 2024 Swastha Healthcare SaaS. HIPAA &amp; ABHA Compliant.</p>
            <div className="flex items-center gap-6">
              <span className="flex items-center gap-1 text-xs font-bold text-primary">
                <span className="w-2 h-2 rounded-full bg-primary animate-pulse"></span>
                SYSTEMS OPERATIONAL
              </span>
              <span className="text-xs text-on-surface-variant dark:text-slate-400">ISO 27001 Certified</span>
            </div>
          </div>
        </div>
      </footer>
