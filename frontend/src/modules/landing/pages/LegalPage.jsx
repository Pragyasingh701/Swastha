...
export const legalContent = {
  privacy: {
    ...
    sections: [
      ...
      ["Legal bases and consent", "Depending on where you live, we process information to provide the service you request, comply with legal obligations, protect users and the service, pursue legitimate operational interests, and with your consent where consent is required. You may withdraw consent where applicable, although withdrawing it may prevent us from providing a related feature."],
      ...
      ["Security", "We use authentication, authorization checks, access controls, logging, and security practices designed to protect information from unauthorized access, loss, misuse, or alteration. No online service can guarantee absolute security. Use a strong password, keep credentials private, and notify us promptly about suspected unauthorized access."],
      ["Planned security enhancements", "As Swastha evolves, we plan to strengthen our security architecture with industry-standard measures such as bcrypt or an equivalent adaptive password-hashing algorithm for protecting passwords, managed key storage and rotation, encryption at rest for sensitive database fields where appropriate, and the Web Crypto API or equivalent vetted cryptographic libraries for supported client-side cryptographic operations and secure data exchange. These measures will be introduced, tested, and documented before being relied on for production protection. This policy does not represent a security certification or guarantee that every planned measure is currently active."],
      ...
      ["International processing", "Our service providers may process information in countries other than the country where you live. Where required, we use legally recognized safeguards for international transfers and protect information as described in this policy."],
      ["Children", "Swastha is not intended for children who are below the minimum age required to use the service in their location. If you believe a child has provided information without appropriate authorization, contact us so we can review and delete it where required."],
