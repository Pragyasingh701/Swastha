      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto px-6 md:px-10 py-8">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-[#c3c6d7]/20 dark:border-slate-800 shadow-sm p-6 md:p-8">
            <p className="text-sm uppercase tracking-[0.18em] text-[#004ac6] dark:text-blue-400 font-medium">Settings</p>
            <h2 className="mt-2 text-4xl font-bold tracking-tight dark:text-slate-100">Doctor Settings</h2>
            <p className="mt-4 text-[#434655] dark:text-slate-300">This configuration page is connected to the sidebar route so account and clinic preferences can be extended later.</p>
          </div>
        </main>
      </div>
    </div>
